...
def grep_batch(filename):
    ...
    for l in inp.readlines():
        ll = l.strip()
        if ll.startswith('[ ') and ll.endswith('iterations]'): #ll.endswith('mini-batches'):
            tt = ll.split()
            b.append(int(tt[1]))
    inp.close()
    return b
...
#output_pct_valid_file = "output/bays29_s0_e0_md1000_ms6_random_reward_ne100000_w1000_pct"
#output_reward_file = "output/bays29_s0_e0_md1000_ms6_random_reward_ne100000_w1000_pct"
num=12
file_mask= "dataset/"+str(num)+"locations/bays29_s0_e0_md1000_ms"+str(num)+"_random_reward_ne10000_w1000_gt1000.data.mask1.out"
file_no_mask="dataset/"+str(num)+"locations/bays29_s0_e0_md1000_ms"+str(num)+"_random_reward_ne10000_w1000_gt1000.data.mask0.out"

output_pct_valid_file ="dataset/"+str(num)+"locations/bays29_s0_e0_md1000_ms"+str(num)+"_random_reward_ne10000_w1000_gt1000_pct"
output_reward_file="dataset/"+str(num)+"locations/bays29_s0_e0_md1000_ms"+str(num)+"_random_reward_ne10000_w1000_gt1000_pct"
